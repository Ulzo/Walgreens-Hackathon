...
public class Constants {
    ...
    public static final String STAG_API_KEY = "*********Staging API key******";
    public static final String PROD_API_KEY = "*********Production API key******";
    public static final String AFF_ID = "photon";
